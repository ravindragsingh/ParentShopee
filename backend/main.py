...
def startup():
    ...
    try:
        catalog = [
            ...
            dict(id="sight-words-4-6", section="future-ready", section_title="Future-Ready", section_emoji="🚀",
                 topic="sight-words", topic_title="Sight Words", topic_emoji="🔤",
                 age_min=4, age_max=6, title="Ages 4–6", points=10, order_index=41),
            dict(id="money-value-4-6", section="future-ready", section_title="Future-Ready", section_emoji="🚀",
                 topic="money-value", topic_title="Value of Money", topic_emoji="💰",
                 age_min=4, age_max=6, title="Ages 4–6", points=10, order_index=42),
            dict(id="money-value-7-9", section="future-ready", section_title="Future-Ready", section_emoji="🚀",
                 topic="money-value", topic_title="Value of Money", topic_emoji="💰",
                 age_min=7, age_max=9, title="Ages 7–9", points=12, order_index=43),
            dict(id="money-value-10-13", section="future-ready", section_title="Future-Ready", section_emoji="🚀",
                 topic="money-value", topic_title="Value of Money", topic_emoji="💰",
                 age_min=10, age_max=13, title="Ages 10–13", points=15, order_index=44),
            dict(id="money-value-13-17", section="future-ready", section_title="Future-Ready", section_emoji="🚀",
                 topic="money-value", topic_title="Value of Money", topic_emoji="💰",
                 age_min=13, age_max=17, title="Ages 13–17", points=18, order_index=45),
            dict(id="making-friends-4-6", section="future-ready", section_title="Future-Ready", section_emoji="🚀",
                 topic="making-friends", topic_title="Making Friends", topic_emoji="🧑‍🤝‍🧑",
                 age_min=4, age_max=6, title="Ages 4–6", points=10, order_index=46),
            dict(id="making-friends-7-9", section="future-ready", section_title="Future-Ready", section_emoji="🚀",
                 topic="making-friends", topic_title="Making Friends", topic_emoji="🧑‍🤝‍🧑",
                 age_min=7, age_max=9, title="Ages 7–9", points=12, order_index=47),
            dict(id="making-friends-10-13", section="future-ready", section_title="Future-Ready", section_emoji="🚀",
                 topic="making-friends", topic_title="Making Friends", topic_emoji="🧑‍🤝‍🧑",
                 age_min=10, age_max=13, title="Ages 10–13", points=15, order_index=48),
            dict(id="making-friends-13-17", section="future-ready", section_title="Future-Ready", section_emoji="🚀",
                 topic="making-friends", topic_title="Making Friends", topic_emoji="🧑‍🤝‍🧑",
                 age_min=13, age_max=17, title="Ages 13–17", points=18, order_index=49),
        ]
