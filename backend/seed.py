...
def seed_db(db: Session):
    ...
    for u in [
        ...
        DBUser(id="kid1",    name="Alice",   username="kid1",    password="pass1", role="kid",    guardian_id="parent1", avatar="🐱", created_at=now(), pin="123456", pin_auto_generated="0"),
        DBUser(id="kid2",    name="Bob",     username="kid2",    password="pass1", role="kid",    guardian_id="parent1", avatar="🐶", created_at=now(), pin="284917", pin_auto_generated="0"),
