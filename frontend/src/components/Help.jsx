...
// ── Guardian help content ─────────────────────────────────────────────────────

function GuardianHelp() {
  return (
    <div>
      <div style={{
        ...
        <p style={{ fontSize: '0.875rem', color: '#115e59', lineHeight: 1.6, margin: 0 }}>
          ...
          and can send messages to your children and co-guardian.
        </p>
      </div>
      ...
      <Section icon="🚀" title="Getting Started" defaultOpen>
        ...
        <Step number="2" text="Optionally open the Admin Panel (☰ menu) to invite a co-guardian (partner, spouse, etc.) who shares full access to your family — give them a name, avatar, and PIN too." />
      ...
      <Section icon="🔐" title="Profiles & PINs">
        <Tip emoji="🔑" text="Only you sign in with a real username and password. Kids and your co-guardian get in through the profile picker with their own 6-digit PIN — no separate login to create or remember for them." />
        ...
        <Tip emoji="❓" text="Forgot your own PIN? Click your tile in the picker, then 'Forgot PIN?' — re-enter your account password to set a new PIN on the spot. Kids and your co-guardian don't need this: reset their PIN any time from the Kids tab or Admin Panel." />
      </Section>
      ...
      <Section icon="👨‍👩‍👧" title="Co-Guardian Management">
        <Tip emoji="👨‍👩‍👧" text="Open the Admin Panel (☰ menu) to add a second guardian (partner, spouse, etc.) who shares full access to your family — children, chores, shop and wallets." />
        <Tip emoji="➕" text="Enter their name, pick an avatar, and set a 6-digit PIN, then click 'Create Co-Guardian'. Share the PIN with them — they unlock their profile from the picker, same as your kids." />
        <Tip emoji="🔑" text="Use '🔑 Change PIN' on their card any time you need to update it." />
        <Tip emoji="🗑️" text="'Remove Co-Guardian' immediately revokes their access. Only one co-guardian per family is allowed." />
      </Section>
      ...
      <Section icon="💬" title="Messaging">
        <Tip emoji="💬" text="Use the Messages tab to chat with your kids or co-guardian directly inside the app." />
...
function KidHelp() {
  return (
    <div>
      ...
      <Section icon="🚀" title="Getting Started" defaultOpen>
        <Step number="1" text="Open the Chores tab — you'll see all available chores your guardian has created." />
        <Step number="2" text="Click 'Claim & Complete' on a chore you want to do. Do the chore in real life, then click the button." />
        <Step number="3" text="The chore moves to 'My Pending' while your guardian reviews it." />
        <Step number="4" text="Once your guardian approves it, the points land in your Wallet — go spend them in the Shop!" />
      </Section>
      ...
      <Section icon="📋" title="Doing Chores">
        ...
        <Tip emoji="⏳" text="After you complete a chore, it goes to 'My Pending' until your guardian approves or rejects it." />
      ...
      <Section icon="🛍️" title="Spending in the Shop">
        <Tip emoji="🎁" text="The Shop has rewards your guardian has set up. Browse what's available and how many points each costs." />
      ...
      <Section icon="💰" title="Your Wallet">
        ...
        <Tip emoji="⭐" text="Gold ⭐ entries are bonus points your guardian awarded you — check the message next to it to see why!" />
        <Tip emoji="🔴" text="Red entries are points you spent in the Shop or had removed, with a message explaining why." />
      </Section>

      <Section icon="💬" title="Messaging">
        <Tip emoji="💬" text="Use the Messages tab to send a message to your guardian or co-guardian." />
...
export function HelpTab({ role }) {
  return (
    <div>
      ...
      {role === 'guardian' ? <GuardianHelp /> : <KidHelp />}
    </div>
  )
}
