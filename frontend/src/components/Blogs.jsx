    ...
    content: [
      ...
      },
      {
        ...
        items: [
          ...
          { type: 'image', step: 6, src: '/blog-images/how-to-use/guardian-kids-redesign.png', alt: 'Guardian kids tab', caption: 'Add your kids and manage them from the Kids tab — PIN, birthday, bonuses, and reports, all in one place.' },
          { type: 'image', step: 7, src: '/blog-images/how-to-use/guardian-kids-birthday.png', alt: 'Editing a kid\'s birth month and year', caption: "Set a kid's birth month and year once — it's what the app uses to show them age-appropriate content." },
          { type: 'image', step: 8, src: '/blog-images/how-to-use/guardian-shop.png', alt: 'Guardian shop tab', caption: 'Stock the Shop with rewards worth working for.' },
          { type: 'image', step: 9, src: '/blog-images/how-to-use/add-reward-form.png', alt: 'Add shop item form', caption: 'Adding a reward works the same way — name it, price it, done.' },
          { type: 'image', step: 10, src: '/blog-images/how-to-use/admin-panel.png', alt: 'Admin panel screen', caption: 'Manage your account, PIN, and co-guardian from the Admin Panel.' },
        ],
      },
      {
        type: 'section',
        icon: '🚀',
        title: 'Future-Ready Lessons',
        items: [
          { type: 'image', step: 1, src: '/blog-images/how-to-use/guardian-future-ready.png', alt: 'Guardian Future-Ready tab', caption: "Future-Ready teaches real-world skills — investing, AI, entrepreneurship, communication, digital safety, and more — in short, interactive lessons." },
          { type: 'image', step: 2, src: '/blog-images/how-to-use/guardian-future-ready-manage.png', alt: 'Guardian managing a Future-Ready topic', caption: "Turn on the age bands you want available and set how many points each one earns. Every kid automatically sees the lessons that match their own age." },
          { type: 'image', step: 3, src: '/blog-images/how-to-use/kid-future-ready.png', alt: 'Kid Future-Ready tab', caption: "Kids just see one topic tile each — no age labels, no picking a group. Each one shows whether it's done or ready to start." },
          { type: 'image', step: 4, src: '/blog-images/how-to-use/kid-future-ready-lesson.png', alt: 'Kid reading a Future-Ready lesson slide', caption: 'A lesson is a handful of short slides — no walls of text, just one idea per screen.' },
          { type: 'image', step: 5, src: '/blog-images/how-to-use/kid-future-ready-quiz.png', alt: 'Kid taking a Future-Ready quiz', caption: 'A quick quiz at the end checks what stuck.' },
          { type: 'image', step: 6, src: '/blog-images/how-to-use/kid-future-ready-result.png', alt: 'Kid Future-Ready quiz result screen', caption: 'Pass it, and the points land in their wallet right away.' },
        ],
      },
      {
        type: 'section',
    ...
    case 'image':
      return (
        <figure key={i} style={{ margin: '0 0 32px', textAlign: 'center' }}>
          {block.step && (
            <div style={{ width: 30, height: 30, borderRadius: '50%', background: 'linear-gradient(135deg,#0f766e,#0d9488)', color: '#fff', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', fontWeight: 700, fontSize: '0.85rem', marginBottom: 10 }}>
              {block.step}
            </div>
          )}
          {block.caption && (
            <figcaption style={{ marginBottom: 12, fontSize: '0.92rem', color: '#334155', fontWeight: 600, maxWidth: 340, marginLeft: 'auto', marginRight: 'auto' }}>
              {block.caption}
            </figcaption>
          )}
          <img
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#f8fafc' }}>
      ...
      <div style={{ background: 'linear-gradient(135deg,#0f766e,#0d9488)', padding: '14px 24px', display: 'flex', alignItems: 'center', gap: 16, boxShadow: '0 2px 10px rgba(0,0,0,0.12)' }}>
        ...
        <div style={{ background: '#fff', borderRadius: 8, padding: '3px 8px', display: 'inline-flex', alignItems: 'center', boxShadow: '0 1px 4px rgba(0,0,0,0.15)' }}>
          <img src="/branding/RewardURKids_Website_Compact_Logo.png" alt="Reward Ur Kids" style={{ height: 20, display: 'block' }} />
        </div>
